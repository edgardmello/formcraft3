(() => {
  ...
  // src/js/data/nationalities.js
  var nationalities_exports = {};
  __export(nationalities_exports, {
    nationalities: () => nationalities
  });
  var nationalities;
  var init_nationalities = __esm({
    "src/js/data/nationalities.js"() {
      nationalities = "Afghan\nAlbanian\nAlgerian\nAmerican\nAndorran\nAngolan\nAntiguans\nArgentinean\nArmenian\nAustralian\nAustrian\nAzerbaijani\nBahamian\nBahraini\nBangladeshi\nBarbadian\nBarbudans\nBatswana\nBelarusian\nBelgian\nBelizean\nBeninese\nBhutanese\nBolivian\nBosnian\nBrazilian\nBritish\nBruneian\nBulgarian\nBurkinabe\nBurmese\nBurundian\nCambodian\nCameroonian\nCanadian\nCape Verdean\nCentral African\nChadian\nChilean\nChinese\nColombian\nComoran\nCongolese\nCongolese\nCosta Rican\nCroatian\nCuban\nCypriot\nCzech\nDanish\nDjibouti\nDominican\nDominican\nDutch\nDutchman\nDutchwoman\nEast Timorese\nEcuadorean\nEgyptian\nEmirian\nEquatorial Guinean\nEritrean\nEstonian\nEthiopian\nFijian\nFilipino\nFinnish\nFrench\nGabonese\nGambian\nGeorgian\nGerman\nGhanaian\nGreek\nGrenadian\nGuatemalan\nGuinea-Bissauan\nGuinean\nGuyanese\nHaitian\nHerzegovinian\nHonduran\nHungarian\nI-Kiribati\nIcelander\nIndian\nIndonesian\nIranian\nIraqi\nIrish\nIrish\nIsraeli\nItalian\nIvorian\nJamaican\nJapanese\nJordanian\nKazakhstani\nKenyan\nKittian and Nevisian\nKuwaiti\nKyrgyz\nLaotian\nLatvian\nLebanese\nLiberian\nLibyan\nLiechtensteiner\nLithuanian\nLuxembourger\nMacedonian\nMalagasy\nMalawian\nMalaysian\nMaldivan\nMalian\nMaltese\nMarshallese\nMauritanian\nMauritian\nMexican\nMicronesian\nMoldovan\nMonacan\nMongolian\nMoroccan\nMosotho\nMotswana\nMozambican\nNamibian\nNauruan\nNepalese\nNetherlander\nNew Zealander\nNi-Vanuatu\nNicaraguan\nNigerian\nNigerien\nNorth Korean\nNorthern Irish\nNorwegian\nOmani\nPakistani\nPalauan\nPanamanian\nPapua New Guinean\nParaguayan\nPeruvian\nPolish\nPortuguese\nQatari\nRomanian\nRussian\nRwandan\nSaint Lucian\nSalvadoran\nSamoan\nSan Marinese\nSao Tomean\nSaudi\nScottish\nSenegalese\nSerbian\nSeychellois\nSierra Leonean\nSingaporean\nSlovakian\nSlovenian\nSolomon Islander\nSomali\nSouth African\nSouth Korean\nSpanish\nSri Lankan\nSudanese\nSurinamer\nSwazi\nSwedish\nSwiss\nSyrian\nTaiwanese\nTajik\nTanzanian\nThai\nTogolese\nTongan\nTrinidadian or Tobagonian\nTunisian\nTurkish\nTuvaluan\nUgandan\nUkrainian\nUruguayan\nUzbekistani\nVenezuelan\nVietnamese\nWelsh\nWelsh\nYemenite\nZambian\nZimbabwean";
    }
  });

  // src/js/data/languages.js
  ...
  var init_languages = __esm({
    "src/js/data/languages.js"() {
      languages = "AF==Afrikanns\nSQ==Albanian\nAR==Arabic\nHY==Armenian\nEU==Basque\nBN==Bengali\nBG==Bulgarian\nCA==Catalan\nKM==Cambodian\nZH==Chinese (Mandarin)\nHR==Croation\nCS==Czech\nDA==Danish\nNL==Dutch\nEN==English\nET==Estonian\nFJ==Fiji\nFI==Finnish\nFR==French\nKA==Georgian\nDE==German\nEL==Greek\nGU==Gujarati\nHE==Hebrew\nHI==Hindi\nHU==Hungarian\nIS==Icelandic\nID==Indonesian\nGA==Irish\nIT==Italian\nJA==Japanese\nJW==Javanese\nKO==Korean\nLA==Latin\nLV==Latvian\nLT==Lithuanian\nMK==Macedonian\nMS==Malay\nML==Malayalam\nMT==Maltese\nMI==Maori\nMR==Marathi\nMN==Mongolian\nNE==Nepali\nNO==Norwegian\nFA==Persian\nPL==Polish\nPT==Portuguese\nPA==Punjabi\nQU==Quechua\nRO==Romanian\nRU==Russian\nSM==Samoan\nSR==Serbian\nSK==Slovak\nSL==Slovenian\nES==Spanish\nSW==Swahili\nSV==Swedish \nTA==Tamil\nTT==Tatar\nTE==Telugu\nTH==Thai\nBO==Tibetan\nTO==Tonga\nTR==Turkish\nUK==Ukranian\nUR==Urdu\nUZ==Uzbek\nVI==Vietnamese\nCY==Welsh\nXH==Xhosa";
    }
  });

  // src/js/data/states.js
  var states_exports = {};
  ...
  // src/js/data/field-templates.js
  var field_templates_exports = {};
  __export(field_templates_exports, {
    fieldHTML: () => fieldHTML,
    fieldOptions: () => fieldOptions
  });
  var translate, fieldHTML, fieldOptions, startGeneral, endGeneral, startValidation, endValidation, startStyling, endStyling, columnWidthTemplate, labelAndSubLabelTemplate, instructionsTemplate, altLabelTemplate, instructionsAltTemplate, hideFieldTemplate;
  var init_field_templates = __esm({
    "src/js/data/field-templates.js"() {
      translate = window.FC.fct;
      fieldHTML = {};
      fieldOptions = {};
      startGeneral = '<div class="opt-general">';
      endGeneral = "</div>";
      startValidation = '<div class="opt-validation">';
      endValidation = "</div>";
      startStyling = '<div class="opt-styling">';
      endStyling = "</div>";
      columnWidthTemplate = `<label class='w-1'><span>Col. Width</span><input type='text' ng-model='element.elementDefaults.field_width'><i data-html='true' tooltip data-placement='top' data-toggle='tooltip' title='${translate["Set Width Option"]}<img src="${FC.pluginurl}/assets/images/width-info.png" style="width: 190px; height: auto; display: block"/>' class='formcraft-icon tooltip-icon'>info_outline</i></label>`;
      labelAndSubLabelTemplate = `<label class="w-1"><span>Label</span><input fc-placeholder type="text" ng-model="element.elementDefaults.main_label"></label><label class="w-1"><span>Sub Label</span><input sub-label type="text" ng-model="element.elementDefaults.sub_label"></label>`;
      instructionsTemplate = `<label class="w-2"><span>Instructions</span><input type="text" ng-model="element.elementDefaults.instructions"></label>`;
      altLabelTemplate = `<label class="w-1"><span>Alt Label</span><input type="text" ng-model="element.elementDefaults.altLabel"><i data-html="true" tooltip data-placement="top" data-toggle="tooltip" title="<div style='width: 150px'>${translate["Alt Label"]}</div>" class="formcraft-icon tooltip-icon">info_outline</i></label>`;
      instructionsAltTemplate = `<label class="w-1"><span>Instructions</span><input type="text" ng-model="element.elementDefaults.instructions"></label><label class="w-1"><span>Alt Label</span><input type="text" ng-model="element.elementDefaults.altLabel"><i data-html="true" tooltip data-placement="top" data-toggle="tooltip" title="<div style='width: 150px'>${translate["Alt Label"]}</div>" class="formcraft-icon tooltip-icon">info_outline</i></label>`;
      hideFieldTemplate = `<label class="w-3"><input value="1" type="checkbox" ng-model="element.elementDefaults.hidden_default"> Hide Field on Page Load</label>`;
      ...
      fieldOptions.heading = `${startGeneral}<label class='w-2'><span>Label</span><input fc-placeholder type='text' ng-model='element.elementDefaults.main_label'></label>${columnWidthTemplate}<label class='w-2'><span>Heading Text</span><input sub-label type='text' ng-model='element.elementDefaults.field_value'></label>${altLabelTemplate}${endGeneral}${startStyling}<label class='w2-1'><span>Padding Top</span><input type='text' ng-model='element.elementDefaults.paddingTop' placeholder='10px'/></label><label class='w2-1'><span>Padding Bottom</span><input type='text' ng-model='element.elementDefaults.paddingBottom' placeholder='10px'/></label><div class='w-3'><div>Format</div><div class='button-checkbox-group'><label ng-click='element.elementDefaults.headingSize = element.elementDefaults.headingSize + 0.1' title='Increase font size'>A+</label><label ng-click='element.elementDefaults.headingSize = element.elementDefaults.headingSize - 0.1' title='Decrease font size'>A-</label></div><div class='button-checkbox-group' style='margin-left: 1em'><label style='font-weight: bold' title='Bold text'>B<input type='checkbox' value='bold' ng-model='element.elementDefaults.headingWeight' update-label/></label></div><div class='button-checkbox-group' style='margin-left: 1em'><label><i class='formcraft-icon'>format_align_left</i><input type='radio' name='align_{{$index}}' ng-model='element.elementDefaults.headingAlignment' value='left' update-label/></label><label><i class='formcraft-icon'>format_align_center</i><input type='radio' name='align_{{$index}}' ng-model='element.elementDefaults.headingAlignment' value='center' update-label/></label><label><i class='formcraft-icon'>format_align_right</i><input type='radio' name='align_{{$index}}' ng-model='element.elementDefaults.headingAlignment' value='right' update-label/></label></div></div><label class='w-1'><span>Color</span><input angular-color type='text' ng-model='element.elementDefaults.font_color' data-default-color='#444444'/></label><label class='w-1'><span>Background</span><input angular-color type='text' ng-model='element.elementDefaults.background_color' data-default-color=''/></label>${endStyling}`;
      ...
      fieldOptions.email = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsAltTemplate}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.autoresponder'> Send Autoresponder <span class='more-info'>Autoresponder settings are available under Settings -> Email -> Email Autoresponders</span></label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.replyTo'> Set as Reply-To Address</label>${hideFieldTemplate}${endGeneral}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.readonly'> Read-Only Field</label>${endValidation}`;
      ...
      fieldOptions.textarea = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsAltTemplate}<label class='w-1'><span>Rows</span><input type='text' ng-model='element.elementDefaults.field_height'></label>${hideFieldTemplate}${endGeneral}${startValidation}<label class='w-1'><span>Min Chars</span><input type='text' ng-model='element.elementDefaults.Validation.minChar'></label><label class='w-1'><span>Max Chars</span><input type='text' ng-model='element.elementDefaults.Validation.maxChar'></label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.show_count'> Show Character Count</label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.dropdown = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsTemplate}${altLabelTemplate}${hideFieldTemplate}${endGeneral}${startStyling}<label class='w-3'><i class='formcraft-icon tooltip-icon' tooltip data-toggle='tooltip' title='${translate["Dropdown One"]}: <br><strong>100==Apple</strong><br>${translate["Dropdown Two"]}<img style="height: 50px" src="${FC.pluginurl}/assets/images/value==text.png"/>'>info_outline</i><span>Options </span><a data-post-id='489' class='trigger-help read-more-textarea'>(read more)</a><textarea rows='5' ng-model='element.elementDefaults.options_list' checkbox-list></textarea></label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.autocomplete'> Autocomplete Type</label><div class='w-3' style='white-space:normal'>Autofill: <a ng-click='addCountries($parent.$index, $index)'>Countries</a>, <a ng-click='addStates($parent.$index, $index)'>US States</a>, <a ng-click='addNationalities($parent.$index, $index)'>Nationalities</a>, <a ng-click='addLanguages($parent.$index, $index)'>Languages</a>, <a ng-click='addDays($parent.$index, $index)'>Days of the Week</a>, <a ng-click='addMonths($parent.$index, $index)'>Months</a></div>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.submit = `${startGeneral}<label class='w-2'><span>Label</span><input type='text' ng-model='element.elementDefaults.main_label'></label><label class='w-1'><span>Col. Width</span><input type='text' ng-model='element.elementDefaults.field_width'><i data-html='true' tooltip data-placement='top' data-toggle='tooltip' title='${translate["Set Width Option"]}<img src="${FC.pluginurl}/assets/images/width-info.png" style="width: 190px; height: auto; display: block"/>' class='formcraft-icon tooltip-icon'>info_outline</i></label>${hideFieldTemplate}${endGeneral}${startStyling}<div class='w-3'><span>Alignment</span><br/><div class='button-checkbox-group'><label class='button-checkbox'><i class='formcraft-icon'>format_align_left</i><input type='radio' name='{{element.identifier}}_name' ng-model='element.elementDefaults.alignment' value='left' update-label/></label><label class='button-checkbox'><i class='formcraft-icon'>format_align_center</i><input type='radio' name='{{element.identifier}}_name' ng-model='element.elementDefaults.alignment' value='center' update-label/></label><label class='button-checkbox'><i class='formcraft-icon'>format_align_right</i><input type='radio' name='{{element.identifier}}_name' ng-model='element.elementDefaults.alignment' value='right' update-label /></label></div></div><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.isWide'> Wide Button</label>${endStyling}`;
      ...
      fieldOptions.slider = `${startGeneral}<label class='w-1'><span>Label</span><input type='text' ng-model='element.elementDefaults.main_label'></label><label class='w-1'><span>Sub Label</span><input type='text' ng-model='element.elementDefaults.sub_label'></label><label class='w-1'><span>Col. Width</span><input type='text' ng-model='element.elementDefaults.field_width'><i data-html='true' tooltip data-placement='top' data-toggle='tooltip' title='${translate["Set Width Option"]}<img src="${FC.pluginurl}/assets/images/width-info.png" style="width: 190px; height: auto; display: block"/>' class='formcraft-icon tooltip-icon'>info_outline</i></label><label class="w-1"><span>Instructions</span><input type="text" ng-model="element.elementDefaults.instructions"></label><label class="w-1"><span>Alt Label</span><input type="text" ng-model="element.elementDefaults.altLabel"><i data-html="true" tooltip data-placement="top" data-toggle="tooltip" title="<div style='width: 150px'>${translate["Alt Label"]}</div>" class="formcraft-icon tooltip-icon">info_outline</i></label>${hideFieldTemplate}${endGeneral}${startStyling}<label class='w-1'><span>Min</span><input type='text' ng-model='element.elementDefaults.range_min'></label><label class='w-1'><span>Max</span><input type='text' ng-model='element.elementDefaults.range_max'></label><label class='w-1'><span>Step</span><input type='text' ng-model='element.elementDefaults.range_step'></label><label class='w-1'><span>Prefix</span><input type='text' ng-model='element.elementDefaults.prefix' ng-trim='false'></label><label class='w-1'><span>Suffix</span><input type='text' ng-model='element.elementDefaults.suffix' ng-trim='false'></label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.range_true' value='true'> Range Selector</label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.scale_true' value='true'> Show Scale</label>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.timepicker = `${startGeneral}<label class='w-1'><span>Label</span><input type='text' ng-model='element.elementDefaults.main_label'></label><label class='w-1'><span>Sub Label</span><input type='text' ng-model='element.elementDefaults.sub_label'></label><label class='w-1'><span>Col. Width</span><input type='text' ng-model='element.elementDefaults.field_width'><i data-html='true' tooltip data-placement='top' data-toggle='tooltip' title='${translate["Set Width Option"]}<img src="${FC.pluginurl}/assets/images/width-info.png" style="width: 190px; height: auto; display: block"/>' class='formcraft-icon tooltip-icon'>info_outline</i></label><label class="w-1"><span>Instructions</span><input type="text" ng-model="element.elementDefaults.instructions"></label><label class="w-1"><span>Alt Label</span><input type="text" ng-model="element.elementDefaults.altLabel"><i data-html="true" tooltip data-placement="top" data-toggle="tooltip" title="<div style='width: 150px'>${translate["Alt Label"]}</div>" class="formcraft-icon tooltip-icon">info_outline</i></label>${hideFieldTemplate}${endGeneral}${startStyling}<label class='w2-1'><span>Min Hrs</span><input type='text' ng-model='element.elementDefaults.hrs_min'></label><label class='w2-1'><span>Max Hrs</span><input type='text' ng-model='element.elementDefaults.hrs_max'></label><label class='w2-1'><span>Hrs Step</span><input type='text' ng-model='element.elementDefaults.hrs_step'></label><label class='w2-1'><span>Minute Step</span><input type='text' ng-model='element.elementDefaults.minute_step'></label><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.format_24'> Hide AM / PM</label>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.address = `${startGeneral}<label class='w-1'><span>Label</span><input fc-placeholder type='text' ng-model='element.elementDefaults.main_label'></label><label class='w-1'><span>Sub Label</span><input type='text' ng-model='element.elementDefaults.sub_label'></label><label class='w-1'><span>Col. Width</span><input type='text' ng-model='element.elementDefaults.field_width'><i data-html='true' tooltip data-placement='top' data-toggle='tooltip' title='${translate["Set Width Option"]}<img src="${FC.pluginurl}/assets/images/width-info.png" style="width: 190px; height: auto; display: block"/>' class='formcraft-icon tooltip-icon'>info_outline</i></label><label class="w-1"><span>Alt Label</span><input type="text" ng-model="element.elementDefaults.altLabel"><i data-html="true" tooltip data-placement="top" data-toggle="tooltip" title="<div style='width: 150px'>${translate["Alt Label"]}</div>" class="formcraft-icon tooltip-icon">info_outline</i></label>${hideFieldTemplate}${endGeneral}${startStyling}<label class='w-2'><span>Google API Key</span><input type='text' ng-model='element.elementDefaults.google_key'></label><label class='w-1'><span>Map Height</span><input type='text' ng-model='element.elementDefaults.map_height'></label><label class='w-3'><span>Restrict To Country</span><input type='text' ng-model='element.elementDefaults.restrict' placeholder='CA'></label><p>Click on Get A Key button on <a href='https://developers.google.com/maps/documentation/javascript/get-api-key' target='_blank'>this</a> page to get your Google API Key.</p><label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.map'> Show Map</label>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.star = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsTemplate}${altLabelTemplate}${hideFieldTemplate}${endGeneral}${startStyling}<div><label class='w-3'><i class='formcraft-icon tooltip-icon' tooltip data-toggle='tooltip' title='${translate["Dropdown One"]}: <br><strong>100==Apple</strong><br>${translate["Dropdown Two"]}<img style="height: 50px" src="${FC.pluginurl}/assets/images/value==text.png"/>'>info_outline</i><span>Options</span><textarea rows='5' ng-model='element.elementDefaults.options_list' checkbox-list></textarea></label></div><label class='w-3'><span>Option Width</span><input type='text' ng-model='element.elementDefaults.option_width'></label>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.thumb = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsTemplate}${altLabelTemplate}${hideFieldTemplate}${endGeneral}${startStyling}<div><label class='w-3'><i class='formcraft-icon tooltip-icon' tooltip data-toggle='tooltip' title='${translate["Dropdown One"]}: <br><strong>100==Apple</strong><br>${translate["Dropdown Two"]}<img style="height: 50px" src="${FC.pluginurl}/assets/images/value==text.png"/>'>info_outline</i><span>Options</span><textarea rows='5' ng-model='element.elementDefaults.options_list' checkbox-list></textarea></label></div><label class='w-3'><span>Option Width</span><input type='text' ng-model='element.elementDefaults.option_width'></label>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
      ...
      fieldOptions.matrix = `${startGeneral}${labelAndSubLabelTemplate}${columnWidthTemplate}${instructionsTemplate}${altLabelTemplate}${hideFieldTemplate}${endGeneral}${startStyling}<div><label class='w-3'><span>Options</span><textarea rows='5' ng-model='element.elementDefaults.matrix_rows' matrix-rows></textarea></label><label class='w-3'><span>Columns</span><textarea rows='5' ng-model='element.elementDefaults.matrix_cols' matrix-cols></textarea></label></div>${endStyling}${startValidation}<label class='w-3'><input type='checkbox' ng-model='element.elementDefaults.required'> Required Field</label>${endValidation}`;
    }
  });

  // src/js/formcraft-builder.js
  var require_formcraft_builder = __commonJS({
    "src/js/formcraft-builder.js"() {
      var xss = require_lib2();
      var translate2 = window.FC.fct;
      xss.whiteList["label"] = [];
      window.helpQuery = [];
      ...
      function loadAddons() {
        jQuery.ajax({
          ...
          for (let type in addons) {
            ...
            if (type === "free") {
              addonType = translate2["Free AddOns"];
            }
            if (type === "purchased") {
              addonType = translate2["Purchased AddOns"];
            }
            if (type === "other") {
              addonType = translate2["Paid AddOns"];
            }
            ...
            for (let addon in addons[type]) {
              ...
              if (addons[type][addon].price === 0 || addons[type][addon].purchased === true) {
                button = `<button class="toggle-install formcraft-button small" data-plugin="${addons[type][addon].ID}"><span>Install Plugin</span><div class='formcraft-loader'></div></button><a class="read-more-addon" href="http://formcraft-wp.com/addons/?page_id=${addons[type][addon].ID}" target="_blank">${translate2["read more"]}</a>`;
              } else {
                button = `<a target="_blank" href="http://formcraft-wp.com/buy/?addons=${addons[type][addon].ID}&key=${FC.licenseKey}" class='formcraft-button small purchase green'><span>Purchase for $${addons[type][addon].price}</span></a><a class="read-more-addon" href="http://formcraft-wp.com/addons/?page_id=${addons[type][addon].ID}" target="_blank">${translate2["read more"]}</a>`;
              }
          ...
          if (nos === 0) {
            html = `<div class='no-addons'>${translate2["Nothing Left To Install"]}</div>`;
          }
          jQuery(".new-addons").html(html);
        }).fail(function() {
          jQuery(".new-addons").html("");
          globalNotification("error", translate2["Please check your internet connection"]);
        });
      }
      function updateHelp(query, type, log) {
        ...
        jQuery.ajax({
          ...
          let html = `<div id="help-top"><span class="formcraft-button small" id="help-back">\u2190 ${translate2["back"]}</span><span class="formcraft-button small" id="help-home">Index</span><span class="formcraft-button small close" data-dismiss="fc_modal" aria-label="Close">close</span></div><div class="article-content">`;
          if (type === "categories") {
            let htmlListElement = "";
            if (query.indexOf("search=") !== -1) {
              ...
              html = `${html}<h2>${translate2["Help Topics"]}</h2><div style="padding-bottom: 10%">`;
            }
            let HTMLarray = [];
            if (response.length === 0) {
              html = `${html}<div class="no-posts"><i class="icon-emo-unhappy"></i> ${translate2["Sorry, nothing here"]}</div>`;
            } else {
              ...
              for (let y2 in HTMLarray) {
                html = `${html}<h3 class="category" data-id="${HTMLarray[y2][0][1]}">${y2}</h3>`;
                htmlListElement = `${htmlListElement}<li class="category" data-id="${HTMLarray[y2][0][1]}">${y2}</li>`;
                let current = 0;
                for (let z in HTMLarray[y2]) {
                  if (current === 6) {
                    break;
                  }
                  current += 1;
                  html = html + HTMLarray[y2][z][0];
                }
              }
              htmlListElement = `${htmlListElement}<li><a style="box-shadow:none;outline:none;color:inherit;text-decoration:none;margin:-8px -12px;display: block;height: 34px;line-height: 34px;padding-left: 12px;" target="_blank" href="http://formcraft-wp.com/support">${translate2["Contact Support"]}</a></li>`;
            }
      ...
      jQuery(document).ready(function() {
        ...
        jQuery("body").on("click", ".toggle-install", function() {
          ...
          jQuery.ajax({
            ...
            if (response.failed) {
              ...
              globalNotification("error", translate2["Unknown Error."]);
              jQuery(this).removeClass("loading").removeAttr("disabled");
            }
          }).fail(function() {
            globalNotification("error", translate2["Unknown Error."]);
        ...
        document.addEventListener("mousedown", function(event2) {
          const $target = jQuery(event2.target);
          const isOutside = $target.closest(".form-element").length === 0 && $target.closest(".form-options").length === 0 && $target.closest(".field-actions-sidebar").length === 0 && $target.closest("#main-options-panel").length === 0 && $target.closest("#form_styling_box").length === 0 && $target.closest("#form_addon_box").length === 0 && $target.closest("#form_options_box").length === 0 && $target.closest("#form_logic_box").length === 0 && $target.closest('[id$="_button"]').length === 0 && $target.closest(".iris-picker").length === 0 && $target.closest(".wp-color-picker").length === 0 && $target.closest(".iris-square").length === 0 && $target.closest(".iris-slider").length === 0 && !$target.hasClass("formcraft-icon");
          if (isOutside) {
        ...
        jQuery("body").on("click", "#help-content-content .post, #help-content-content .trigger-post", function(event2) {
      ...
      function saveFormJQuery(builder, addons, addField, callback) {
        ...
        jQuery.ajax({
          ...
          if (response.failed) {
            ...
            globalNotification("error", translate2["Failed Saving."] + translate2["Unknown Error."]);
          }
        }).fail(function(response, status, code) {
          if (code === "Forbidden") {
            globalNotification("error", translate2["Failed Saving. Please try disabing your firewall, or security plugin."]);
          } else {
            globalNotification("error", translate2["Failed Saving"]);
          }
        }).always(function() {
      ...
      FormCraftApp.directive("compile", function($compile) {
        return function(scope, element, attrs) {
          scope.$watch(
            function(scope2) {
              return scope2.$eval(attrs.compile);
            },
            function(value) {
              element.html(value);
      ...
      FormCraftApp.directive("compilesafe", function($compile) {
        return function(scope, element, attrs) {
          scope.$watch(
            function(scope2) {
              return scope2.$eval(attrs.compilesafe);
            },
            function(value) {
          ...
          $attrs.$observe("watchShowOptions", function innerObserveFunction() {
            ...
            if ($attrs.watchShowOptions === "true" && $scope.isShowPristine === false) {
              for (let x in $scope.$parent.$parent.Builder.FormElements) {
                for (let y2 in $scope.$parent.$parent.Builder.FormElements[x]) {
                  if (typeof $scope.$parent.$parent.Builder.FormElements[x][y2].showOptions === "undefined") {
                    continue;
                  }
                }
              }
          ...
          $scope.$watch("listOfFields", function() {
            setTimeout(function() {
              ...
              $element.selectize({
                ...
                onChange: () => {
                  let placeholder2 = $attrs.placeholder;
                  if (typeof placeholder2 !== "undefined") {
                    $element.parent().find(".selectize-input > input").attr("placeholder", placeholder2);
                  }
                }
              });
              ...
              if (typeof ngModelCtrl.$viewValue !== "undefined") {
                if (ngModelCtrl.$viewValue === "placeholder") {
                  for (let x in $scope.Builder.FormElements) {
                    for (let y2 in $scope.Builder.FormElements[x]) {
                      if (typeof $scope.Builder.FormElements[x][y2] === "object") {
                        let temp = $scope.Builder.FormElements[x][y2].elementDefaults.main_label;
                        $scope.Builder.FormElements[x][y2].elementDefaults.main_label_placeholder = temp;
                      }
                    }
                  }
                } else {
                  for (let x in $scope.Builder.FormElements) {
                    for (let y2 in $scope.Builder.FormElements[x]) {
                      if (typeof $scope.Builder.FormElements[x][y2] === "object") {
                        if (typeof $scope.Builder.FormElements[x][y2].elementDefaults.maskPlaceholder !== "undefined" && $scope.Builder.FormElements[x][y2].elementDefaults.maskPlaceholder.trim() !== "") {
                          $scope.Builder.FormElements[x][y2].elementDefaults.main_label_placeholder = $scope.Builder.FormElements[x][y2].elementDefaults.maskPlaceholder;
                        } else {
                          $scope.Builder.FormElements[x][y2].elementDefaults.main_label_placeholder = "";
                        }
                      }
                    }
                  }
      ...
      FormCraftApp.directive("slider", function() {
        return {
          ...
          link: function($scope, $element, $attrs, ngModelCtrl) {
            ...
            options.change = options.slide = function(event2, ui) {
              let value;
          ...
          link: function($scope, $element, $attrs, ngModelCtrl) {
            ...
            $attrs.$observe("dateMin", function innerObserveFunction() {
              if ($attrs.dateMin !== "" && parseInt($attrs.dateMin, 10) === $attrs.dateMin) {
                let someDate = /* @__PURE__ */ new Date();
      ...
      FormCraftApp.controller("FormController", function($scope, $locale, $http, $timeout) {
        ...
        $scope.testEmail = function() {
          ...
          $http({
            ...
            if (response.failed) {
              ...
              $scope.TestEmailResultMore = `<br/><strong>${translate2["Debug Info"]}:</strong><br/>${response.debug}`;
            } else {
        ...
        $scope.FormElements = (function() {
          $http({
            ...
            $scope.Builder.Config.decimal_separator = $scope.Builder.Config.decimal_separator === void 0 ? "." : $scope.Builder.Config.decimal_separator;
            $scope.Builder.Config.thousand_separator = $scope.Builder.Config.thousand_separator === void 0 ? "" : $scope.Builder.Config.thousand_separator;
            $scope.Builder.label_style = $scope.Builder.label_style === void 0 ? "inline" : $scope.Builder.label_style;
            $scope.Builder.form_width = $scope.Builder.form_width === void 0 ? "420px" : $scope.Builder.form_width;
            if ($scope.Builder.form_width.match(/^[0-9]+$/) !== null) {
              $scope.Builder.form_width = `${$scope.Builder.form_width}px`;
            }
            $scope.Builder.form_frame = $scope.Builder.form_frame === void 0 ? "visible" : $scope.Builder.form_frame;
            $scope.Builder.form_field_border = $scope.Builder.form_field_border === void 0 ? "visible" : $scope.Builder.form_field_border;
            $scope.Builder.font_size = $scope.Builder.font_size === void 0 ? 100 : $scope.Builder.font_size;
            $scope.Builder.Config.font_color = $scope.Builder.Config.font_color === void 0 ? "#666666" : $scope.Builder.Config.font_color;
            ...
            $scope.Builder.nextText = $scope.Builder.nextText === void 0 ? "Next" : $scope.Builder.nextText;
            $scope.Builder.prevText = $scope.Builder.prevText === void 0 ? "Previous" : $scope.Builder.prevText;
            $scope.Builder.Config.font_family = $scope.Builder.Config.font_family === void 0 ? "inherit" : $scope.Builder.Config.font_family;
            $scope.Builder.form_internal_alignment = $scope.Builder.form_internal_alignment === void 0 ? "left" : $scope.Builder.form_internal_alignment;
            $scope.Builder.Config.Messages.is_required = $scope.Builder.Config.Messages.is_required || translate2["Required"];
            $scope.Builder.Config.Messages.is_invalid = $scope.Builder.Config.Messages.is_invalid || translate2["Invalid"];
            $scope.Builder.Config.Messages.min_char = $scope.Builder.Config.Messages.min_char || translate2["Min [x] characters required"];
            $scope.Builder.Config.Messages.max_char = $scope.Builder.Config.Messages.max_char || translate2["Max [x] characters allowed"];
            $scope.Builder.Config.Messages.min_files = $scope.Builder.Config.Messages.min_files || translate2["Min [x] file(s) required"];
            $scope.Builder.Config.Messages.max_files = $scope.Builder.Config.Messages.max_files || translate2["Max [x] file(s) allowed"];
            $scope.Builder.Config.Messages.max_file_size = $scope.Builder.Config.Messages.max_file_size || translate2["Files bigger than [x] MB not allowed"];
            $scope.Builder.Config.Messages.allow_email = $scope.Builder.Config.Messages.allow_email || translate2["Invalid Email"];
            $scope.Builder.Config.Messages.allow_url = $scope.Builder.Config.Messages.allow_url || translate2["Invalid URL"];
            $scope.Builder.Config.Messages.allow_regexp = $scope.Builder.Config.Messages.allow_regexp || translate2["Invalid Expression"];
            $scope.Builder.Config.Messages.allow_alphabets = $scope.Builder.Config.Messages.allow_alphabets || translate2["Only alphabets"];
            $scope.Builder.Config.Messages.allow_numbers = $scope.Builder.Config.Messages.allow_numbers || translate2["Only numbers"];
            $scope.Builder.Config.Messages.allow_alphanumeric = $scope.Builder.Config.Messages.allow_alphanumeric || translate2["Should be alphanumeric"];
            $scope.Builder.Config.Messages.failed = $scope.Builder.Config.Messages.failed || translate2["Please correct the errors and try again"];
            $scope.Builder.Config.Messages.success = $scope.Builder.Config.Messages.success || translate2["Message received"];
            $scope.Builder.Config.autoresponder.email_body = $scope.Builder.Config.autoresponder.email_body || translate2["Email Content Autoresponder"];
            $scope.Builder.Config.autoresponder.email_subject = $scope.Builder.Config.autoresponder.email_subject || translate2["Thank you for your submission"];
            ...
            $scope.Builder.Config.notifications.email_body = $scope.Builder.Config.notifications.email_body || translate2["<p>Hello,</p><p><br></p><p>You have received a new form submission for the form [Form Name]. Here are the details:</p><p>[Form Content]</p><p><br></p><p>Page: [URL]<br>Unique ID: #[Entry ID]<br>Date: [Date]<br>Time: [Time]</p>"];
            $scope.Builder.Config.notifications.email_subject = $scope.Builder.Config.notifications.email_subject || "[Form Name] - " + translate2["New Form Submission"];
            ...
            $scope.$watch("Builder.Config.font_family", function(newValue) {
              ...
              const isSystemFont = !font || font === "inherit" || font.indexOf("Arial") !== -1 || font.indexOf("Courier") !== -1 || font.indexOf("sans-serif") !== -1 || font.indexOf("Georgia") !== -1 || font.indexOf("serif") !== -1 || font.indexOf("monospace") !== -1 || font.indexOf("-apple-system") !== -1 || font.indexOf("BlinkMac") !== -1;
              if (!isSystemFont) {
            ...
            for (let x in $scope.Builder.FormElements) {
              ...
              $scope.$watchCollection("Builder.FormElements", function() {
                ...
                for (let x2 in $scope.Builder.FormElements) {
                  $scope.sortableOptions.push(createOptions(x2));
                }
              });
              for (let y2 in $scope.Builder.FormElements[x]) {
                $scope.$watchCollection(`Builder.FormElements[${x}][${y2}].elementDefaults.main_label`, function() {
                  if ($scope.toX < initY) {
                    $scope.toX += 1;
                  }
                  if ($scope.toX === initY) {
            ...
            setTimeout(() => {
              ...
              $scope.Builder.FormElements.forEach((page, pageNos) => {
                $scope.Builder.FormElements[pageNos].forEach((x, y2) => {
                  if (otherFields.indexOf(x.type) > -1) {
                    let xF = otherFields.indexOf(x.type);
                    $scope.Builder.FormElements[pageNos][y2].element = `<div compile='addField.others[${xF}].fieldHTMLTemplate'></div>`;
                    $scope.Builder.FormElements[pageNos][y2].elementOptions = `<div compile='addField.others[${xF}].fieldOptionTemplate'></div>`;
                  } else if (paymentFields.indexOf(x.type) > -1) {
                    let xF = paymentFields.indexOf(x.type);
                    $scope.Builder.FormElements[pageNos][y2].element = `<div compile='addField.payments[${xF}].fieldHTMLTemplate'></div>`;
                    $scope.Builder.FormElements[pageNos][y2].elementOptions = `<div compile='addField.payments[${xF}].fieldOptionTemplate'></div>`;
                  } else if (typeof $scope.fieldOptionTemplate[x.type] !== "undefined") {
                    $scope.Builder.FormElements[pageNos][y2].elementOptions = `<div compile='fieldOptionTemplate["${x.type}"]'></div>`;
                  }
                });
              });
              $scope.$apply();
            ...
            $scope.$watchGroup(slidingPanels, function(newValue, oldValue) {
              newValue.forEach((x, y2) => {
                if (x === false && oldValue[y2] === true) {
                  $scope.Builder.Config[slidingPanels[y2].split(".")[1]] = "hiding";
                  $timeout(function() {
                    $scope.Builder.Config[slidingPanels[y2].split(".")[1]] = false;
                  }, 350);
                }
              });
            });
        ...
        $scope.applyLogicFix = function() {
          for (let x in $scope.Builder.Config.Logic) {
            for (let y2 in $scope.Builder.Config.Logic[x][1]) {
              applySelectFix(`cons_select_fix_${x}_${y2}`, $scope.Builder.Config.Logic[x][1][y2][4]);
            }
            for (let y2 in $scope.Builder.Config.Logic[x][0]) {
              applySelectFix(`select_fix_${x}_${y2}`, $scope.Builder.Config.Logic[x][0][y2][0]);
            }
          }
        };
        ...
        $scope.addCountries = function($parent, $index) {
          $scope.Builder.FormElements[$parent][$index].elementDefaults.options_list = (init_countries(), __toCommonJS(countries_exports)).countries;
        };
        $scope.addNationalities = function($parent, $index) {
          $scope.Builder.FormElements[$parent][$index].elementDefaults.options_list = (init_nationalities(), __toCommonJS(nationalities_exports)).nationalities;
        };
        $scope.addLanguages = function($parent, $index) {
          $scope.Builder.FormElements[$parent][$index].elementDefaults.options_list = (init_languages(), __toCommonJS(languages_exports)).languages;
        };
        $scope.addStates = function($parent, $index) {
          $scope.Builder.FormElements[$parent][$index].elementDefaults.options_list = (init_states(), __toCommonJS(states_exports)).states;
        };
        ...
        $scope.listIcons = (init_icons(), __toCommonJS(icons_exports)).icons;
        ...
        $scope.fieldHTMLTemplate = (init_field_templates(), __toCommonJS(field_templates_exports)).fieldHTML;
        $scope.fieldOptionTemplate = (init_field_templates(), __toCommonJS(field_templates_exports)).fieldOptions;
        $scope.addFormElement = function(type, position) {
          ...
          $scope.Builder.elements_counter = $scope.Builder.elements_counter === void 0 ? 1 : $scope.Builder.elements_counter + 1;
          ...
          switch (type) {
            case "heading":
              ...
              $scope.elementTemp.main_label = translate2["Heading"];
              $scope.elementTemp.field_value = translate2["Some Title"];
            ...
            case "oneLineText":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Name"];
              $scope.elementTemp.sub_label = translate2["your full name"];
            ...
            case "password":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Password"];
              $scope.elementTemp.sub_label = translate2["check your caps"];
              break;
            case "email":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = "<div compile='fieldOptionTemplate.email'></div>";
              $scope.elementTemp.main_label = translate2["Email"];
              $scope.elementTemp.sub_label = translate2["a valid email"];
              break;
            case "textarea":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Comments"];
              $scope.elementTemp.sub_label = translate2["more details"];
              $scope.elementTemp.field_height = "5";
              break;
            case "checkbox":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Favorite Fruits"];
              $scope.elementTemp.sub_label = translate2["pick one!"];
            ...
            case "dropdown":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Language"];
              $scope.elementTemp.sub_label = translate2["pick one!"];
            ...
            case "datepicker":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Date"];
              $scope.elementTemp.sub_label = translate2["of appointment"];
            ...
            case "customText":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.html = translate2["Add some text or <strong>HTML</strong> here"];
              $scope.elementTemp.main_label = translate2["Text Field"];
            ...
            case "submit":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Submit Form"];
            ...
            case "fileupload":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["File"];
              $scope.elementTemp.sub_label = translate2["upload"];
              $scope.elementTemp.button_label = "Upload";
              break;
            case "slider":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Slider"];
              $scope.elementTemp.sub_label = translate2["take your pick"];
            ...
            case "timepicker":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Time"];
              $scope.elementTemp.sub_label = translate2["of appointment"];
            ...
            case "address":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Address"];
              $scope.elementTemp.sub_label = translate2["your home / office"];
              $scope.elementTemp.map_height = 240;
              break;
            case "star":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Rate"];
              $scope.elementTemp.sub_label = translate2["our support"];
              $scope.elementTemp.options_list = `1==${translate2["Bad"]}
2==${translate2["Could be better"]}
3==${translate2["So so"]}
4==${translate2["Good"]}
5==${translate2["Excellent"]}`;
              break;
            case "thumb":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Liked the food?"];
              $scope.elementTemp.sub_label = translate2["let us know"];
              $scope.elementTemp.options_list = "1==Yep\n0==Nope";
              break;
            case "matrix":
              $scope.element = `<div compile='fieldHTMLTemplate["${type}"]'></div>`;
              $scope.elementOptions = `<div compile='fieldOptionTemplate["${type}"]'></div>`;
              $scope.elementTemp.main_label = translate2["Survey"];
              $scope.elementTemp.sub_label = "";
              $scope.elementTemp.matrix_rows = translate2["How Was the Food?"] + "\n" + translate2["How Was the Service?"];
              $scope.elementTemp.matrix_cols = translate2["Poor"] + "\n" + translate2["Average"] + "\n" + translate2["Good"];
              break;
            default:
              for (let x in $scope.addField.payments) {
                if ($scope.addField.payments[x].name === type) {
                  for (let y2 in $scope.Builder.FormElements) {
                    for (let z in $scope.Builder.FormElements[y2]) {
                      if ($scope.Builder.FormElements[y2][z].type === $scope.addField.payments[x].name && $scope.Builder.FormElements[y2][z].restrict === true) {
                        return false;
                      }
                    }
                  }
                  ...
                  $scope.restrict = true;
                  for (let y2 in $scope.addField.payments[x].defaults) {
                    $scope.elementTemp[y2] = $scope.addField.payments[x].defaults[y2];
                  }
                }
              }
              for (let x in $scope.addField.others) {
                if ($scope.addField.others[x].name === type) {
                  ...
                  $scope.restrict = true;
                  for (let y2 in $scope.addField.others[x].defaults) {
                    $scope.elementTemp[y2] = $scope.addField.others[x].defaults[y2];
                  }
                }
              }
              break;
