...
// Shim for textAngular backwards compatibility (angular.lowercase/uppercase removed in 1.7+).
angular.lowercase = angular.$$lowercase || function(s){ return angular.isString(s) ? s.toLowerCase() : s; };
angular.uppercase = angular.$$uppercase || function(s){ return angular.isString(s) ? s.toUpperCase() : s; };
